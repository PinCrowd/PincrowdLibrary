...
/**
 * @category   Pincrowd
 * @package    Pincrowd_Log
 * @subpackage Pincrowd_Log_Writer
 */
/**
 * @see Pincrowd_Log_Writer_Abstract
 */
 ...
 *         'filterName' => 'Priority',
 *         'filterParams' => array('priority' => Pincrowd_Log::WARN)),
 *         array('writerName' => 'Firebug', 'filterName' => 'Priority',
 *             'filterParams' => array('priority' => Pincrowd_Log::INFO))
 *     )
 * );
 ...
 * );
 * $log = new Zend_log();
 * $log->addWriter(Pincrowd_Log_Writer_MongoDb::factory($config));
 ...
 * $writer = Pincrowd_Log_Writer_MongoDb::factory($config);
 * $log = new Zend_log();
 ...
 * $log = new Zend_log();
 * $writer = new Pincrowd_Log_Writer_MongoDb($collection);
 * $log->addWriter($writer);
 * $log->err(__METHOD__);
 * </code>
 *
 ...
 * resources.log.mongo.defaultNamespace = "Pincrowd_Log_Writer"
 ...
 *
 */
class Pincrowd_Log_Writer_MongoDb extends Zend_Log_Writer_Abstract
{
    /**
     *
     *
    ...
    /**
     * (non-PHPdoc)
     * @see Pincrowd_Log_Writer_Abstract::_write()
     */
