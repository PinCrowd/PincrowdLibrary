 ...
 * @subpackage Pincrowd_Cache_Backend
 */
 ...
 * @subpackage Pincrowd_Cache_Backend
 */
class Pincrowd_Cache_Backend_MongoDb extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     ...
     * @return Pincrowd_Cache_Backend_MongoDb
     */
    ...
    private function _registerTag($id, $tag) {
        ...
        if (!$res) {
            $this->_log(
                "Pincrowd_Cache_Backend_MongoDb::_registerTag() : ".
