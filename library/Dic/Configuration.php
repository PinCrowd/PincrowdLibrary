...
class Configuration
{
    ...
    /**
     * @var Pincrowd\Di\DependencyInjector
     */
    protected $di = null;
    ...
    public function __construct($data)
    {
        if ($data instanceof Traversable) {
            ...
            throw new Exception\InvalidArgumentException(
                'Configuration data must be of type Pincrowd\Config\Config or an array'
            );
        }
        $this->data = $data;
    }
            ...
            switch ($definitionType) {
                ...
                case 'class':
                    foreach ($definitionData as $className => $classData) {
                        $classDefinitions = $di->definitions()->getDefinitionsByType('Pincrowd\Di\Definition\ClassDefinition');
