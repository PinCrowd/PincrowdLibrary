...
use Pincrowd\Code\Scanner\DerivedClassScanner,
    Pincrowd\Code\Scanner\AggregateDirectoryScanner,
    Pincrowd\Code\Scanner\DirectoryScanner,
    Pincrowd\Code\Scanner\FileScanner,
    
    Pincrowd\Di\Definition\Annotation,
    Pincrowd\Code\Annotation\AnnotationManager,
    Pincrowd\Code\Reflection,
    Pincrowd\Code\Annotation\AnnotationCollection;
...
class CompilerDefinition implements Definition
{
    ...
    {
        /* @var $classScanner \Pincrowd\Code\Scanner\DerivedClassScanner */
    ...
    protected function processClass($class)
    {
        ...
        /** @var $rClass \Pincrowd\Code\Reflection\ClassReflection */
        ...
        if ($strategy->getUseAnnotations() == true) {
            ...
            if (($annotations instanceof AnnotationCollection)
                && $annotations->hasAnnotation('Pincrowd\Di\Definition\Annotation\Instantiator')) {
        ...
        foreach ($rClass->getMethods(Reflection\MethodReflection::IS_PUBLIC) as $rMethod) {
            ...
            if ($strategy->getUseAnnotations() == true) {
                ...
                if (($annotations instanceof AnnotationCollection)
                    && $annotations->hasAnnotation('Pincrowd\Di\Definition\Annotation\Inject')) {
...
//
//        // matches the interface injection pattern
//        /** @var $sInterface \Pincrowd\Code\Scanner\ClassScanner */
...
//
//            /** @var $p \Pincrowd\Code\Scanner\ParameterScanner  */
//            $actualParamName = $p->getName();
//
