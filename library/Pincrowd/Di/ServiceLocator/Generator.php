...
namespace Pincrowd\Di\ServiceLocator;

use Pincrowd\Di\Di,
    Pincrowd\CodeGenerator\Php as CodeGen,
    Pincrowd\Di\DependencyInjection,
    Pincrowd\Di\Exception;
...
class Generator
{
     ...
     *
     * Creates a Pincrowd\CodeGenerator\Php\PhpFile object that has 
    ...
    public function getCodeGenerator($filename = null)
    {
        ...
        $classFile->setUse('Pincrowd\Di\ServiceLocator')
                  ->setClass($container);
